...
import 'package:ecommerce_clean_architecture/features/main/presentation/home/widgets/custom_fruit_items_grid_view.dart';
    ...
    return BlocBuilder<ProductsCubit, ProductsStates>(
      builder: (context, state) {
        if (state is SuccessProductsState) {
          ...
          return SliverToBoxAdapter(child: CustomCircularProgressWidget());
        } else {
