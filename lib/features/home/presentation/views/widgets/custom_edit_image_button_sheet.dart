...
import 'package:ecommerce_clean_architecture/features/home/presentation/views/widgets/update_user_image_bloc_provider.dart';
...
class _CustomEditImageButtonSheetState
  ...
  Widget build(BuildContext context) {
    return UpdateUserImageBlocProvider(
      child: Builder(
        builder: (context) {
          return Container(
