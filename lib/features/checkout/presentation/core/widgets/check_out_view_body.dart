...
class _CheckOutViewBodyState extends State<CheckOutViewBody> {
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: CustomButton(
              ...
              onPressed: () {
                if (currentPage == 0) {
                  handleShippingSectionValidation(context: context);
                } else if (currentPage == 1) {
                  handleAddressSection(context);
                } else if (currentPage == 2) {
                  handlePaymentSection(context);
                } else if (currentPage == 3) {
                  triggerAddOrderCubit(context);
                }
              },
            ),
          ),
  ...
  void handleShippingSectionValidation({required BuildContext context}) {
  ...
  void handleAddressSection(BuildContext context) {
    pageController.nextPage(
      duration: Duration(milliseconds: 300),
      curve: Curves.easeIn,
    );
  ...
  void triggerAddOrderCubit(BuildContext context) {
